...
trait GoogleHelper
{
    ...
    public function distanceInGoogle($lat1, $lng1, $lat2, $lng2)
    {
        ...
        $request = $client->request('GET', "distancematrix/json?avoid=tolls&departure_time=1995289600&traffic_model=pessimistic&origins={$origins}&destinations={$destination}&language=id&key={$this->apiKey}");
