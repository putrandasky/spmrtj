<template>
  <div>
    ...
    <div class=" text-center">
      ...
      <h5 class="text-primary mb-5">Partisipasi Anda sangat membantu kami dalam mewujudkan transportasi publik yang semakin baik</h5>
      <strong class="">Silahkan mengisi data diri Anda untuk memperoleh kesempatan mendapatkan souvenir menarik</strong>
      <br />
      <strong class="">Responden beruntung akan kami hubungi melalui kontak yang diberikan!</strong>
    </div>
