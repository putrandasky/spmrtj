<template>
  <div>
    ...
    <opening v-if="content == 'intro1'" @onClick="content = 'intro2'" :title="spTitle"></opening>
    <opening-second v-if="content == 'intro2'" @onClick="content = 'main'" :title="spTitle"></opening-second>
    <div v-if="content == 'main'">
      <div class="w-100 text-primary  text-justify" v-show="stateQuestion == 'primary'">
        <p>
      ...
      <question-slot class="w-100" v-show="stateQuestion == 'secondary'">
        ...
        <template slot="bottom">
          <b-button block variant="primary" @click="submitSecondary('time')">
            Cuma menghemat sedikit waktu
          </b-button>
          <b-button block variant="primary" @click="submitSecondary('cost')">
            Tarifnya kemahalan
          </b-button>
        </template>
      </question-slot>
    ...
    <div v-if="content == 'main2'">
      <question-slot>
        ...
        <template slot="bottom">
          <b-form-radio-group id="travel_purpose" stacked v-model="stateDataCollection.isUsingFeederReguler" :options="options.isUsingFeederReguler" button-variant="outline-primary" buttons name="is_using_feeder_reguler" class="btn-block"></b-form-radio-group>
          <b-btn variant="success" @click="submitStateCollection()" block v-if="stateDataCollection.isUsingFeederReguler !== null">Kirim</b-btn>
        </template>
      </question-slot>
    </div>
  </div>
