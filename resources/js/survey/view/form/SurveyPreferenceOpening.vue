...
<script>
    export default {
        ...
        data: function () {
            return {
                ...
                data:[
                    ...
                    {
                        title:"Preferensi Layanan Park & Ride Pengguna Motor Pribadi",
                        img:"./img/sp-car-park-2.jpg",
                        content:""
                    },
                    {
        ...
        mounted(){
            this.selectedData = this.data[this.data.findIndex(a=>a.title == this.title)]
        },
        methods:{
            handleClick(){
