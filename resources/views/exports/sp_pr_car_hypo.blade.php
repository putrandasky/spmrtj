<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$respondent->sp_park_ride_hypo_car_respond(1)->respond}}</td>
      <td>{{$respondent->sp_park_ride_hypo_car_respond(2)->respond}}</td>
      <td>{{$respondent->sp_park_ride_hypo_car_respond(3)->respond}}</td>
      <td>{{$respondent->sp_park_ride_hypo_car_respond(4)->respond}}</td>
      <td>{{$respondent->sp_park_ride_hypo_car_respond(5)->respond}}</td>
      <td>{{$respondent->sp_park_ride_hypo_car_respond(6)->respond}}</td>
      <td>{{$respondent->sp_park_ride_hypo_car_respond(7)->respond}}</td>
    </tr>
    @endforeach
  </tbody>
</table>
