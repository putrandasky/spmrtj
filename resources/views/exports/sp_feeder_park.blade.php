<table>
  ...
  <tbody>
    ...
    <tr>
      @php
      $park12000 = $respondent->sp_feeder_park_respond(1)->respond ?? "" ;
      $park10000 = $respondent->sp_feeder_park_respond(2)->respond ?? "" ;
      $park8000 = $respondent->sp_feeder_park_respond(3)->respond ?? "" ;
      $park7000 = $respondent->sp_feeder_park_respond(4)->respond ?? "" ;
      $park5000 = $respondent->sp_feeder_park_respond(5)->respond ?? "" ;
      $park3500 = $respondent->sp_feeder_park_respond(6)->respond ?? "" ;
      @endphp
      <td>{{$respondent->id}}</td>
      <td>{{$park12000}}</td>
      <td>{{$park10000}}</td>
